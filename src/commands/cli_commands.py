...
from commands.commands import handle_config_command, handle_activity_create_command, handle_activity_ls_command, handle_activity_info_command, handle_skill_create_command, handle_skill_ls_command, handle_skill_info_command, handle_plan_create_command, handle_plan_ls_command, handle_plan_info_command, handle_practice_create_command, handle_practice_ls_command, handle_practice_info_command

"""
Config Commands
"""
def handle_config_cli_command(args: Namespace):
    handle_config_command(activity_directory=args.directory)
